...
public class SecurityConfig  {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .antMatchers(HttpMethod.GET, "/rides/{rideId}/{username}/reservationInfo").hasAnyAuthority("BESTUURDER", "PASSAGIER")
                .antMatchers(HttpMethod.DELETE, "/rides/{id}").hasAuthority("BESTUURDER")
                .antMatchers(HttpMethod.GET, "/rides/{id}").hasAnyAuthority("BESTUURDER", "PASSAGIER")
